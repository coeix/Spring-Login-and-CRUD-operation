 ...
 * logica di business. 
 * 
 * Fornisce metodi per inserire, aggiornare e rimuovere un’entità
 * e metodi che istanziano ed eseguono query specifiche. 
 * 
 * L‘obiettivo di questo pattern è quello di separare il codice per la persistenza dal codice di business e a migliorare
